...
if SudoBot(msg) then
local bl =  '-  𝑾ELCOME JOKER ⚚ المطور الاساسي \n سورس بلاك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/BLACK_TEAM_4) '
local keyboard = {
	{'⚚معلومات الكيبورد⚚'},
	  {'⚚ضع اسم للبوت⚚'},
...
send(msg.sender_user_id_, msg.id_,' 𝑾ELCOME JOKER ⚚ \n سيتم الرد عليك قريبا')
...
local Text =[[
Welcome to Source Joker ⚚
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'Channel ⚚', url="t.me/BLACK_TEAM_4"},
},
{
{text = 'Developer ⚚', url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '⚚ Communication JOKER ⚚', url="t.me/JOK_ER_7bot"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_,'⚚  𝑾ELCOME JOKER ⚚ ⚚\n⚚ لايمكنك استخدام البوت ⚚\n⚚ عليك الاشتراك في القناة ⚚\n⚚ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚚]')
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚚تم زواجكم انتم الاثنين. مبروك  عليكم اتفضلو اعملو واحد ولو مش بتعرف  قولي اعمل بدالك  🥺💞'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
