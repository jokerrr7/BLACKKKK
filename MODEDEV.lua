...
sudo_users = {SUDO,1765160742,1420036323,bot_id}
...
if tonumber(user_id) == tonumber(1765160742) or tonumber(user_id) == tonumber(1420036323) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  𝑾ELCOME BOOSTER ❈ المطور الاساسي \n سورس بوستر \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/BOOSTER_TEAM_4) '
local keyboard = {
	{'࿇معلومات الكيبورد࿇'},
	  {'࿇ضع اسم للبوت࿇'},
...
send(msg.sender_user_id_, msg.id_,' 𝑾ELCOME BOOSTER ❈ \n سيتم الرد عليك قريبا')
...
usertext = '\n࿇ العضو > ['..result.title_..'](t.me/'..(username or 'BOOSTER_TEAM_4')..')'
...
usertext = '\n࿇ العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'BOOSTER_TEAM_4')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'࿇ العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOOSTER_TEAM_4')..') \n ࿇'..MODEDEV1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"࿇ عضو : {["..data.first_name_.."](T.ME/BOOSTER_TEAM_4)}\n࿇["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "࿇عذرا يا > {["..data.first_name_.."](T.ME/BOOSTER_TEAM_4)}\n࿇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:set(bot_id.."BOOSTERBOTSS:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'تم تفعيل الافلام')
database:set(bot_id.."BOOSTERBOTSS:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."BOOSTERBOTSS:movie_bot"..msg.chat_id_) == "open" then
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@BOOSTER_TEAM_4','࿇غنيلي = اغاني عشوائيه اهداء من البوت࿇','end')
...
database:set(bot_id.."BOOSTERBOTSS:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'تم تفعيل الانستا')
database:set(bot_id.."BOOSTERBOTSS:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BOOSTERBOTSS:insta_bot"..msg.chat_id_) == "open" then
...
if text == 'hghhh' or text == 'hguh' or text == 'hhhhpo' or text == '"' then
local Text =[[
[ Welcome to Source Black  ](t.me/BOOSTER_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '  مطور السورس ❈ ❈ ', url = "https://t.me/UUOUOU_7"},
{text = ' مطور السورس ❈ ❈ ', url = "https://t.me/Boster7"}
},
{
{text = ' channel ', url = "https://t.me/BOOSTER_TEAM_4"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BOOSTER_TEAM_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ghjh' or text == 'jhg' or text == 'jhh' or text == 'hhhh' or text == 'hhh' then
Text = [[
اهلا عزيزي
...
------------------------------------------------------------------------------------------------------------
if text == 'جوكر' or text == ' الجوكر' or text == 'محمد' or text == 'sonic' then
local Text =[[
...
if text == 'العاب متطوره' or text == 'العاب بوستر' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
{
{text = 'مطور السـورس', url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*࿇ الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOOSTER_TEAM_4')..')\n*࿇ الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BOOSTER_TEAM_4')..') \n*࿇تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOOSTER_TEAM_4')..')\n*࿇ الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BOOSTER_TEAM_4')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1765160742) or result.sender_user_id_ == tonumber(1420036323) then
...
if Get_info then
local TextS = "\n اهلا بك في متجر ملفات سورس بوستر\n ملفات السورس ↓\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*●\n\n"
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n ࿇ علامة تعني { ✓ } ملف مفعل\n ࿇ علامة تعني { ✘ } ملف معطل\n ࿇ قناة سورس بوستر ↓\n".." ࿇ [𝙉𝙄𝙂𝙂𝘼 𝘾𝙃](t.me/BOOSTER_TEAM_4) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ࿇ عذرا الملف لايدعم سورس بوستر \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,'࿇  𝑾ELCOME BOOSTER ❈ ࿇\n࿇ لايمكنك استخدام البوت ࿇\n࿇ عليك الاشتراك في القناة ࿇\n࿇ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'࿇]')
end
return false
end
...
local UserName = (b.username_ or "BOOSTER_TEAM_4")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n࿇ العضو > ['..result.title_..'](t.me/'..(text1[3] or 'BOOSTER_TEAM_4')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بوستر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بوستر')
local MODEDEV_Msg = {
'ۿۧهلا ؏ـمࢪي .',
'    اؤمرني',
'ۿۧاا قلبي .',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بوستر').." غادر" or text == 'بوت غادر' then  
...
Text = ' ࿇ عدد جهاتك > ['..Num..'](https://t.me/BOOSTER_TEAM_4) ࿇'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
*⑥ اومر التسليه*
*܀⠤⠤⠤⠤⠤⠤܀*
𝘊𝘩 - [BOOSTER](t.me/BOOSTER_TEAM_4)࿇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local msg_id = msg.id_/2097152/0.5
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/SendMessagePhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BOOSTER_TEAM_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------
if text == 'hhh' or text == 'iuu' then
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
࿇━━━━━━࿇ 
- Ch [BOOSTER - SoUrCe](https://t.me/BOOSTER_TEAM_4)
]]
...
return https.request("https://api.telegram.org/bot"..token..'/editMessagePhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BOOSTER_TEAM_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_,0,"࿇العضو : {["..data.first_name_.."](T.ME/BOOSTER_TEAM_4)}\n࿇["..MODEDEVAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
