...
var = true  
if tonumber(user_id) == tonumber(1646796547) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 black المطور الاساسي \n سورس بلاك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/TEM_BLACK1) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
local Text =[[
مرحبا بك في سورس بلاك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناة السورس', url="t.me/TEM_BLACK1},
},
{
{text = 'مطور السورس', url="t.me/eljo_ker_m"},
{text = 'مطور السورس', url="t.me/PHP57"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
------------------------------------------------------------------------------------------------------------
if text == 'جوكر' or text == 'جوكر' or text == 'جوكر' or text == 'JOK' then
local Text =[[
...
if text == 'جاك' or text == 'جاك' or text == 'خالد' or text == 'JACK' then
local Text =[[
مطور السورس . يمكنك التواصل معه عن طريق معرفه
]]
keyboard = {} 
...
{
{text = 'مطور السـورس', url="t.me/eljo_ker_m"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if result.sender_user_id_ == tonumber(1646796547) then
send(msg.chat_id_, msg.id_, "•لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(1646796547) then﻿ send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")﻿ return false ﻿ end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'TEM_BLACK1')..')'
status  = '\n تم حظره عام من المجموعات'
texts = usertext..status
...
if result.sender_user_id_ == tonumber(1646796547) then﻿ send(msg.chat_id_, msg.id_, "•لا يمكنك كتم مطور  السورس \n")﻿ return false ﻿ end
