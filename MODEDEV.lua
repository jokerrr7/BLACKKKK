...
if SudoBot(msg) then
local bl =  '-  𝑾ELCOME BLACK ⚚ المطور الاساسي \n سورس بلاك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/BLACK_TEAM_4) '
local keyboard = {
	{'❈︙معلومات الكيبورد❈︙'},
	  {'❈︙ضع اسم للبوت❈︙'},
...
send(msg.sender_user_id_, msg.id_,' 𝑾ELCOME BLACK ⚚ \n سيتم الرد عليك قريبا')
...
send(msg.chat_id_, msg.id_,'اصدار سورس بلاك V⁵') 
end
...
{{text = 'JACK.',url="t.me/PHP57"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text =[[
[ ❈︙WELCOME TO 𝚂𝙾𝚄𝚁𝙲𝙴 BLACK ](t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '- JOKER .', url = "https://t.me/UUOUOU_7"}
},
{
{text = '- JACK .', url = "https://t.me/PHP57"}
},
{
...
if text == ("ايدي") or text == ("id") or text == ("ID")  or text == ("Id") or text == ("ا") or text == ("بتاعي ") and msg.reply_to_message_id_ == 0 and not database:get(bot_id..'Bot:Id'..msg.chat_id_) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
❈︙━━━━━━❈︙ 
- Ch [BLACK - SoUrCe](https://t.me/BLACK_TEAM_4)
]]
