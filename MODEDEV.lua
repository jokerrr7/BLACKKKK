...
sudo_users = {SUDO,1792413842,bot_id}
...
if tonumber(user_id) == tonumber(1792413842) then  
var = true  
...
[ ❰ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐄𝐆𝐘𝐏𝐓𝐈𝐀𝐍 𝐒𝐐𝐔𝐀𝐑𝐄𝐒 ❱ ](t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❍ - 𝘋𝘌𝘝', url="t.me/revorb0t"},
},
{
{text = '❍ - 𝐁𝐋𝐀𝐂𝐊 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/BLACK_TEAM_4"},
},
}
{text = '❍ - 𝐀𝐃𝐃 𝐓𝐇𝐄 𝐁𝐎𝐓 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/BLACK_TEAM_4/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'م1' or text == 'م2' or text == 'م3' or text == 'م4' or text == 'م5' then
Text = [[
❍ - اهلا بيك عزيزي لايوجد هاكذا اوامر في البوت اكتب الاوامر وتحكم فيها من خلال الازرار بالاسفل
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if result.sender_user_id_ == tonumber(1792413842) then
...
if result.id_ == tonumber(1792413842) then
send(msg.chat_id_, msg.id_, "❍  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n❍العضو > ['..result.title_..'](t.me/'..(username or 'BLACK_TEAM_4')..')'
...
local Text = [[
اسمي  ]].. Name_Bot..[[ يا حبيبي
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❍ - 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑', url = "https://t.me/"..UserName_Dev}
},
{
{text = '❍ - 𝐀𝐃𝐃 𝐓𝐇𝐄 𝐁𝐎𝐓 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
