...
sudo_users = {SUDO,1325450849,bot_id}
...
if tonumber(user_id) == tonumber(1325450849) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐬𝐧𝐚𝐤 المطور الاساسي \n سورس سناك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/UU_SNAK) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐬𝐧𝐚𝐤 \n سيتم الرد عليك قريبا')
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'UU_SNAK')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SNAK')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_SNAK')..') \n •'..MODEDEV1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/UU_SNAK)}\n•["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/UU_SNAK)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@UU_SNAK','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
local Text =[[
° 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗕𝗥𝗢 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗡𝗔𝗞°
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = ' 𝗗𝗘𝗩 .', url = "https://t.me/UU_0P"}
},
{
{text = ' 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗡𝗔𝗞 .', url = "https://t.me/UU_SNAK"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_2vx/3744&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
------------------------------------------------------------------------------------------------------------
if text == 'البوب' or text == 'بوب' or text == 'البوبب' or text == 'bob' then
local Text =[[
𝗛𝗘𝗬 𝗕𝗢𝗕 𝗪𝗜𝗧𝗛 𝗨
]]
keyboard = {} 
...
{
{text = '𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗪𝗹𝘁𝗵 𝗠𝗲', url="t.me/UU_0P"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_2vx/4015&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end



if text == 'العاب متطوره' or text == 'العاب سناك' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
{
{text = 'مطور السـورس', url="t.me/UU_0P"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_SNAK')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'UU_SNAK')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_SNAK')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'UU_SNAK')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1325450849) then
...
if result.id_ == tonumber(1325450849) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'UU_SNAK')..')'
...
if Get_info then
local TextS = "\n اهلا بك في متجر ملفات سورس سناك\n ملفات السورس ↓\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*●\n\n"
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n • علامة تعني { ✓ } ملف مفعل\n • علامة تعني { ✘ } ملف معطل\n • قناة سورس سناك ↓\n".." • [𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐡𝐚𝐧𝐧𝐞𝐥](t.me/UU_SNAK) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,'•  𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐬𝐧𝐚𝐤 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
local UserName = (b.username_ or "UU_SNAK")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'UU_SNAK')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سناك')
local MODEDEV_Msg = {
'ۿۧهلا ؏ـمࢪي .',
'    اؤمرني',
'ۿۧاا قلبي .',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناك').." غادر" or text == 'بوت غادر' then  
...
print("it is Bot")
N = (database:get(bot_id.."Tshake:Name:Bot") or "..Namebot..")
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/UU_SNAK) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [SNAK - SoUrCe](https://t.me/UU_SNAK)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/UU_SNAK)}\n•["..MODEDEVAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
