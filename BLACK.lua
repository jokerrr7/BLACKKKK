...
send(msg.chat_id_, msg.id_,'  اصدار سورس بلاك الثاني 2') 
end
...
{
{text = ' 𝗗𝗘𝗩 .', url = "https://t.me/UUOUOU_7"}
},
{
{text = ' 𝗗𝗘𝗩 .', url = "https://t.me/PHP57"}
},
{
{text = ' 𝗦𝗢𝗨𝗥𝗖𝗘 BLACK .', url = "https://t.me/BLACK_TEAM_4"}
},
{
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4/3744&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
