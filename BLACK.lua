...
if res ~= 200 then
print('\27[0;31m《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m《《《《 ᴛᴀᴇᴍ ʙʟᴀᴄᴋ 》》》》\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1765160742,1646796547,bot_id}
...
if tonumber(user_id) == tonumber(1765160742) or tonumber(user_id) == tonumber(1646796547) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  𝐰𝐞𝐥𝐜𝐨𝐦𝐞 ʙʟᴀᴄᴋ المطور الاساسي \n سورس بلاك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/BLACK_TEAM_4) '
local keyboard = {
	{'࿈معلومات الكيبورد࿈'},
	  {'࿈ضع اسم للبوت࿈'},
...
send(msg.sender_user_id_, msg.id_,' 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 ʙʟᴀᴄᴋ \n سيتم الرد عليك قريبا')
...
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/Paulo/main/BLACK.lua')
send(msg.chat_id_, msg.id_,'࿈ تم تحديث السورس')
dofile('BLACK.lua')  
end
if text == 'الاصدار™' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  اصدار سورس بلاك v6') 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴊᴏᴋᴇʀ.',url="t.me/UUOUOU_7"}}, 
{{text = 'ᴊᴀᴄᴋ.',url="t.me/PHP57"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'السورس' or text == 'ياسورس' or text == 'سورس' or text == '"' then
local Text =[[
[ ༺ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝓑𝓛𝓐𝓒𝓚 ༻ ](t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '  - DEV  ', url = "https://t.me/UUOUOU_7"},
{text = '  - DEV  ', url = "https://t.me/PHP57"}
},
{
{text = ' channel ', url = "https://t.me/BLACK_TEAM_4"}
},
}
local msg_id = msg.id_/2097152/0.5
...
------------------------------------------------------------------------------------------------------------
if text == 'الجوكر' or text == 'جوكر' or text == 'JOKER' or text == 'bob' then
local Text =[[
[𝗛𝗘𝗬 𝗝𝗢𝗞𝗘𝗥 𝗪𝗜𝗧𝗛 𝗨 ࿈](t.me/UUOUOU_7)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗪𝕷𝕿𝕳 𝗠𝕰', url="t.me/UUOUOU_7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UUOUOU_7/4015&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'جاك' or text == 'خالد' or text == 'JACK' or text == 'bob' then
local Text =[[
[𝗛𝗘𝗬 𝙅𝘼𝘾𝙆 𝗪𝗜𝗧𝗛 𝗨 ࿊](t.me/PHP57)
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗪𝕷𝕿𝕳 𝗠𝕰', url="t.me/PHP57"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PHP57/4015&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end


if text == 'العاب متطوره' or text == 'العاب بلاك' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
if result.sender_user_id_ == tonumber(1765160742) or result.sender_user_id_ == tonumber(1646796547) then
...
if result.id_ == tonumber(1765160742) or result.id_ == tonmber(1646796547) then
send(msg.chat_id_, msg.id_, "࿈  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n࿈العضو > ['..result.title_..'](t.me/'..(username or 'BLACK_TEAM_4')..')'
...
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n ࿈ علامة تعني { ✓ } ملف مفعل\n ࿈ علامة تعني { ✘ } ملف معطل\n ࿈ قناة سورس بلاك ↓\n".." ࿈ [𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐡𝐚𝐧𝐧𝐞𝐥](t.me/BLACK_TEAM_4) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,'࿈  𝐰𝐞𝐥𝐜𝐨𝐦𝐞 ʙʟᴀᴄᴋ ࿈\n࿈ لايمكنك استخدام البوت ࿈\n࿈ عليك الاشتراك في القناة ࿈\n࿈ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'࿈]')
end
return false
end
...
if MsgText[1] == "@all" and is_JoinChannel(msg) or MsgText[1] == "تاك عام" and is_JoinChannel(msg) and (redis:get(mero..'tagall@all'..msg.chat_id_) == 'open') then
...
print("it is Bot")
N = (database:get(bot_id.."Tshake:Name:Bot") or " بلاك ")
...
*⑥ اومر التسليه*
*܀⠤⠤⠤⠤⠤⠤܀*
𝘊𝘩 - [ᴛᴀᴇᴍ ʙʟᴀᴄᴋ](t.me/BLACK_TEAM_4)࿈
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
࿈━━━━━━࿈ 
- Ch [ᴛᴀᴇᴍ ʙʟᴀᴄᴋ - SoUrCe](https://t.me/BLACK_TEAM_4)
]]
